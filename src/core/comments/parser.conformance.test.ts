...
const TABLE: Expect[] = [
  { file: "01-plain-prose-spans.md", span: 3, block: 0, range: 0, entries: 3, review: true, atEof: true },
  { file: "02-inline-formatting-spans.md", span: 3, block: 0, range: 0, entries: 3, review: true, atEof: true },
  { file: "03-block-anchors.md", span: 0, block: 4, range: 0, entries: 4, review: true, atEof: true },
  { file: "04-range-pair.md", span: 1, block: 0, range: 1, entries: 2, review: true, atEof: true },
  { file: "05-review-block-escapes.md", span: 2, block: 0, range: 0, entries: 2, review: true, atEof: true },
  { file: "06-hard-wrapped.md", span: 2, block: 0, range: 0, entries: 2, review: true, atEof: true },
  { file: "07-long-lines.md", span: 2, block: 0, range: 0, entries: 2, review: true, atEof: true },
  { file: "08-nested-lists.md", span: 2, block: 0, range: 0, entries: 2, review: true, atEof: true },
  { file: "09-unicode.md", span: 2, block: 0, range: 0, entries: 2, review: true, atEof: true },
  { file: "10-dense-anchors.md", span: 50, block: 0, range: 0, entries: 50, review: true, atEof: true },
  ...
  { file: "14-degraded-states.md", span: 2, block: 0, range: 0, entries: 2, review: true, atEof: true },
];
