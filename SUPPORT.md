...
Use the [issue tracker](https://github.com/carlosboeing/penmark/issues) for usage questions, bug reports, and feature requests.

- Search existing issues before opening a new one.
- Use the bug-report form for a reproducible problem.
- Use the feature-request form for a proposed change.
- Include the Penmark version, operating system, VS Code variant and version, and a small example when they help explain the problem.
