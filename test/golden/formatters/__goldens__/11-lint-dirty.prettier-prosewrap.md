...
This document deliberately violates auto-fixable markdownlint rules near
anchors, the way AI-generated docs often do.
...
- item with <!--pmk:s lntspn2a-->a span inside a starred list
  item<!--/pmk:s lntspn2a--> and trailing spaces
- second starred item
