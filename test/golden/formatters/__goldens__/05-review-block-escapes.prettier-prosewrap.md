...
The packaging step accepts a small set of flags. Use <!--pmk:s m6n3b2vc-->the
production flag for release builds<!--/pmk:s m6n3b2vc--> and keep sourcemaps for
everything else.

Continuous integration runs the size gate after packaging. The gate prints
<!--pmk:s q4w7e2rt-->a per-file size table<!--/pmk:s q4w7e2rt--> so regressions
