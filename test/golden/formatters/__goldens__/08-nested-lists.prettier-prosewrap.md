...
- Layer 1: Vitest in plain Node
  - render golden files
  - format parser round-trips, including <!--pmk:s g4h7j2kl-->the escaping rules
    for double hyphens<!--/pmk:s g4h7j2kl-->
  - reconcile scenarios
...
- Layer 3: Playwright on the static harness
  ...
  - the perf scenarios, including <!--pmk:s s3d2f5gh-->the ten-thousand-line
    document with two hundred anchors<!--/pmk:s s3d2f5gh-->
