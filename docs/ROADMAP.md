...
- 2026-06-17 — **CustomTextEditor Support & Context Menus** — Registered `penmark.previewEditor` Custom Editor, refactored webview lifecycle/message handlers into shared `setupPanelEntry` helper (fixing serialiser reload interactivity), registered direct "Open with Penmark" explorer and tab-title context menus.
